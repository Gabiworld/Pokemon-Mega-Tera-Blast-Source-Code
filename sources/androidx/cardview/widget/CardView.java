...
public class CardView extends FrameLayout {
    ...
    public CardView(Context context, AttributeSet attributeSet, int i) {
        ...
        C01691 r3 = new CardViewDelegate() {
        ...
        if (obtainStyledAttributes.hasValue(C0168R.styleable.CardView_cardBackgroundColor)) {
            valueOf = obtainStyledAttributes.getColorStateList(C0168R.styleable.CardView_cardBackgroundColor);
        } else {
            ...
            if (fArr[2] > 0.5f) {
                i2 = getResources().getColor(C0168R.color.cardview_light_background);
            } else {
                i2 = getResources().getColor(C0168R.color.cardview_dark_background);
            }
