...
class AppCompatCompoundButtonHelper {
    ...
    public void loadFromAttributes(android.util.AttributeSet r4, int r5) {
        /*
            ...
            int r5 = androidx.appcompat.C0050R.styleable.CompoundButton_buttonCompat     // Catch:{ all -> 0x007c }
        ...
        L_0x002d:
            ...
            int r5 = androidx.appcompat.C0050R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x007c }
            boolean r5 = r4.hasValue(r5)     // Catch:{ all -> 0x007c }
            if (r5 == 0) goto L_0x004c
            int r5 = androidx.appcompat.C0050R.styleable.CompoundButton_android_button     // Catch:{ all -> 0x007c }
            int r5 = r4.getResourceId(r5, r2)     // Catch:{ all -> 0x007c }
        ...
        L_0x004c:
            int r5 = androidx.appcompat.C0050R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x007c }
            boolean r5 = r4.hasValue(r5)     // Catch:{ all -> 0x007c }
            if (r5 == 0) goto L_0x005f
            android.widget.CompoundButton r5 = r3.mView     // Catch:{ all -> 0x007c }
            int r0 = androidx.appcompat.C0050R.styleable.CompoundButton_buttonTint     // Catch:{ all -> 0x007c }
        ...
        L_0x005f:
            int r5 = androidx.appcompat.C0050R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x007c }
            boolean r5 = r4.hasValue(r5)     // Catch:{ all -> 0x007c }
            if (r5 == 0) goto L_0x0078
            android.widget.CompoundButton r5 = r3.mView     // Catch:{ all -> 0x007c }
            int r0 = androidx.appcompat.C0050R.styleable.CompoundButton_buttonTintMode     // Catch:{ all -> 0x007c }
            r1 = -1
