...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0050R.styleable.ActivityChooserView, attributeSet, obtainStyledAttributes, i, 0);
        }
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C0050R.C0052id.image);
