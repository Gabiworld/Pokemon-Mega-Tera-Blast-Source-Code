...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, Fragment fragment, boolean z) {
        ...
        if (!(fragment.mContainer == null || fragment.mContainer.getTag(C0251R.C0253id.visible_removing_fragment_view_tag) == null)) {
            fragment.mContainer.setTag(C0251R.C0253id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    private static int transitToAnimResourceId(int i, boolean z) {
        ...
        if (i != 4099) {
            ...
            return C0251R.animator.fragment_fade_enter;
        } else {
            return C0251R.animator.fragment_fade_exit;
        }
    }
