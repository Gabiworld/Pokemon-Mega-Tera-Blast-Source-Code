...
public final class CancellationTokenSource implements Closeable {
                    ...
                    if (j != -1) {
                        this.scheduledCancellation = this.executor.schedule(new Runnable() {
                            public final void run() {
                                CancellationTokenSource.m2517cancelAfter$lambda6$lambda5(CancellationTokenSource.this);
                            }
                        }, j, timeUnit);
                    }
                    Unit unit = Unit.INSTANCE;
    ...
    public static final void m2517cancelAfter$lambda6$lambda5(CancellationTokenSource cancellationTokenSource) {
