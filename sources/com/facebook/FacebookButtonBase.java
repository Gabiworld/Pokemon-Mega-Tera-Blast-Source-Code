...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String str, String str2) {
        ...
        configureButton(context, attributeSet, i, i2 == 0 ? C0671R.style.com_facebook_button : i2);
            ...
            try {
                if (!isInEditMode()) {
                    ...
                    if (obtainStyledAttributes.hasValue(0)) {
                        ...
                        setBackgroundColor(ContextCompat.getColor(context, C0671R.color.com_facebook_blue));
                    }
