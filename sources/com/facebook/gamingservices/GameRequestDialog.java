...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        private Result(Bundle bundle) {
            ...
            this.f42to = new ArrayList();
            while (true) {
                if (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, new Object[]{Integer.valueOf(this.f42to.size())}))) {
                    List<String> list = this.f42to;
        ...
        private Result(GraphResponse graphResponse) {
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    this.f42to.add(jSONArray.getString(i));
                }
    ...
    private void showForCloud(GameRequestContent gameRequestContent, Object obj) {
        ...
        C06923 r1 = new DaemonRequest.Callback() {
