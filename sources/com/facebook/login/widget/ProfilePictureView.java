...
public class ProfilePictureView extends FrameLayout {
            ...
            try {
                ...
                this.profileTracker = new ProfileTracker() {
                    ...
                    public void onCurrentProfileChanged(Profile profile, Profile profile2) {
                        ...
                        ProfilePictureView.this.refreshImage(ProfilePictureView.IS_CROPPED_DEFAULT_VALUE);
                    }
                };
            } catch (Throwable th) {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0733R.styleable.com_facebook_profile_picture_view);
                setPresetSize(obtainStyledAttributes.getInt(C0733R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
                this.isCropped = obtainStyledAttributes.getBoolean(C0733R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, IS_CROPPED_DEFAULT_VALUE);
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (this.customizedDefaultProfilePicture == null) {
                    setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C0733R.C0734drawable.com_facebook_profile_picture_blank_square : C0733R.C0734drawable.com_facebook_profile_picture_blank_portrait));
                    return;
                }
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        try {
            ...
            if (i2 == -4) {
                i = C0733R.dimen.com_facebook_profilepictureview_preset_size_large;
            } else if (i2 == -3) {
                i = C0733R.dimen.com_facebook_profilepictureview_preset_size_normal;
            } else if (i2 == -2) {
                i = C0733R.dimen.com_facebook_profilepictureview_preset_size_small;
            } else if (i2 != -1 || !z) {
                return 0;
            } else {
                i = C0733R.dimen.com_facebook_profilepictureview_preset_size_normal;
