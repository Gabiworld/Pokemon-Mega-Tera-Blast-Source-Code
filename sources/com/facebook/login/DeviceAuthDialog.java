...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        C07221 r3 = new Dialog(getActivity(), C0671R.style.com_facebook_auth_dialog) {
    ...
    public View initializeContentView(boolean z) {
        ...
        this.progressBar = inflate.findViewById(C0671R.C0673id.progress_bar);
        this.confirmationCode = (TextView) inflate.findViewById(C0671R.C0673id.confirmation_code);
        ((Button) inflate.findViewById(C0671R.C0673id.cancel_button)).setOnClickListener(new View.OnClickListener() {
        ...
        TextView textView = (TextView) inflate.findViewById(C0671R.C0673id.com_facebook_device_auth_instructions);
        this.instructions = textView;
        textView.setText(Html.fromHtml(getString(C0671R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }

    /* access modifiers changed from: protected */
    public int getLayoutResId(boolean z) {
        return z ? C0671R.layout.com_facebook_smart_device_dialog_fragment : C0671R.layout.com_facebook_device_auth_dialog_fragment;
    }
    ...
    public void presentConfirmation(String str, Utility.PermissionsLists permissionsLists, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C0671R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C0671R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C0671R.string.com_facebook_smart_login_confirmation_cancel);
    ...
    public void onSuccess(String str, Long l, Long l2) {
        ...
        new GraphRequest(new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, (Collection<String>) null, (Collection<String>) null, (Collection<String>) null, (AccessTokenSource) null, date2, (Date) null, date), TournamentShareDialogURIBuilder.f45me, bundle, HttpMethod.GET, new GraphRequest.Callback() {
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.completed.get()) {
                    if (graphResponse.getError() != null) {
                        DeviceAuthDialog.this.onError(graphResponse.getError().getException());
