...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public List<FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler> getOrderedModeHandlers() {
        ...
        arrayList.add(new NativeHandler(this, (C07891) null));
        arrayList.add(new FeedHandler(this, (C07891) null));
        arrayList.add(new WebShareHandler(this, (C07891) null));
        arrayList.add(new CameraEffectHandler(this, (C07891) null));
        arrayList.add(new ShareStoryHandler(this, (C07891) null));
        return arrayList;
    }
    ...
    private class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ NativeHandler(ShareDialog shareDialog, C07891 r2) {
            this();
        }
    ...
    private class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ WebShareHandler(ShareDialog shareDialog, C07891 r2) {
            this();
        }
    ...
    private class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ FeedHandler(ShareDialog shareDialog, C07891 r2) {
            this();
        }
    ...
    private class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, C07891 r2) {
            this();
        }
    ...
    private class ShareStoryHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, C07891 r2) {
            this();
        }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i = C07891.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
    ...
    static /* synthetic */ class C07891 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.ShareDialog.C07891.<clinit>():void");
        }
    }
}
