    ...
    public static final void initialize(File file) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                try {
                    languageInfo = MapsKt.mapOf(TuplesKt.m2408to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.m2408to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m2408to(ViewHierarchyConstants.SPANISH, "3"), TuplesKt.m2408to(ViewHierarchyConstants.JAPANESE, "4"));
                    eventInfo = MapsKt.mapOf(TuplesKt.m2408to(ViewHierarchyConstants.VIEW_CONTENT, AppEventsConstants.EVENT_PARAM_VALUE_NO), TuplesKt.m2408to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.m2408to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m2408to(ViewHierarchyConstants.ADD_TO_WISHLIST, "3"), TuplesKt.m2408to(ViewHierarchyConstants.INITIATE_CHECKOUT, "4"), TuplesKt.m2408to(ViewHierarchyConstants.ADD_PAYMENT_INFO, "5"), TuplesKt.m2408to(ViewHierarchyConstants.PURCHASE, QGConstant.LOGIN_OPEN_TYPE_FACEBOOK), TuplesKt.m2408to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.m2408to(ViewHierarchyConstants.COMPLETE_REGISTRATION, QGConstant.LOGIN_OPEN_TYPE_GOOGLE));
                    textTypeInfo = MapsKt.mapOf(TuplesKt.m2408to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.m2408to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m2408to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, "3"), TuplesKt.m2408to(ViewHierarchyConstants.BUTTON_ID, "4"));
                    initialized = true;
                } catch (Throwable th) {
                    CrashShieldHandler.handleThrowable(th, cls);
                }
