...
public final class SuggestedEventsManager {
        ...
        synchronized (cls) {
            if (!CrashShieldHandler.isObjectCrashing(cls)) {
                try {
                    ...
                    FacebookSdk.getExecutor().execute($$Lambda$SuggestedEventsManager$X12GI3tV4K9K5Vf7rK9SuSaIBPM.INSTANCE);
                } catch (Throwable th) {
    ...
    public static final void m2513enable$lambda0() {
        Class<SuggestedEventsManager> cls = SuggestedEventsManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
