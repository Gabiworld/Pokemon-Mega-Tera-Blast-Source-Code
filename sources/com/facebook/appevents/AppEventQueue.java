...
public final class AppEventQueue {
    ...
    private static final Runnable flushRunnable = $$Lambda$AppEventQueue$8TrmY53jH2EpwpuFZYzLq4V3YIY.INSTANCE;
    ...
    public static final void m2455flushRunnable$lambda0() {
    ...
    public static final void persistToDisk() {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                singleThreadExecutor.execute($$Lambda$AppEventQueue$49sgnqnKReo1qBWmzpIjCNoljE.INSTANCE);
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
            }
        }
    ...
    public static final void m2460persistToDisk$lambda1() {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
            ...
            try {
                ...
                singleThreadExecutor.execute(new Runnable() {
                    public final void run() {
                        AppEventQueue.m2454flush$lambda2(FlushReason.this);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
    ...
    public static final void m2454flush$lambda2(FlushReason flushReason) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(flushReason, "$reason");
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                singleThreadExecutor.execute(new Runnable(appEvent) {
                    ...
                    public final void run() {
                        AppEventQueue.m2452add$lambda3(AccessTokenAppIdPair.this, this.f$1);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
    ...
    public static final void m2452add$lambda3(AccessTokenAppIdPair accessTokenAppIdPair, AppEvent appEvent) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
        ...
        try {
            ...
            newPostRequest.setCallback(new GraphRequest.Callback(newPostRequest, sessionEventsState, flushStatistics) {
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m2453buildRequestForSession$lambda4(AccessTokenAppIdPair.this, this.f$1, this.f$2, this.f$3, graphResponse);
                }
            });
    ...
    public static final void m2453buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppIdPair, GraphRequest graphRequest, SessionEventsState sessionEventsState, FlushStatistics flushStatistics, GraphResponse graphResponse) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
            ...
            try {
                ...
                if (flushResult == FlushResult.NO_CONNECTIVITY) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable(sessionEventsState2) {
                        ...
                        public final void run() {
                            AppEventQueue.m2456handleResponse$lambda5(AccessTokenAppIdPair.this, this.f$1);
                        }
                    });
                }
    ...
    public static final void m2456handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppIdPair, SessionEventsState sessionEventsState) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
