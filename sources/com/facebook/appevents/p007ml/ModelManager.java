package com.facebook.appevents.p007ml;
...
public final class ModelManager {
    ...
    private static final List<String> MTML_INTEGRITY_DETECT_PREDICTION = CollectionsKt.listOf(IntegrityManager.INTEGRITY_TYPE_NONE, IntegrityManager.INTEGRITY_TYPE_ADDRESS, IntegrityManager.INTEGRITY_TYPE_HEALTH);
    ...
    @Metadata(mo13303k = 3, mo13304mv = {1, 5, 1}, mo13306xi = 48)
    ...
    @Metadata(mo13301d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004J\u0006\u0010\u0005\u001a\u00020\u0004j\u0002\b\u0006j\u0002\b\u0007¨\u0006\b"}, mo13302d2 = {"Lcom/facebook/appevents/ml/ModelManager$Task;", "", "(Ljava/lang/String;I)V", "toKey", "", "toUseCase", "MTML_INTEGRITY_DETECT", "MTML_APP_EVENT_PREDICTION", "facebook-core_release"}, mo13303k = 1, mo13304mv = {1, 5, 1}, mo13306xi = 48)
    ...
    public static final void enable() {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                Utility.runOnNonUiThread($$Lambda$ModelManager$uu9yJDIWnxjhyWdMBjdGp9LspI.INSTANCE);
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
            }
        }
    ...
    public static final void m2504enable$lambda0() {
        /*
            java.lang.String r0 = "model_request_timestamp"
            java.lang.String r1 = "models"
            java.lang.Class<com.facebook.appevents.ml.ModelManager> r2 = com.facebook.appevents.p007ml.ModelManager.class
        ...
        L_0x0084:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.p007ml.ModelManager.m2504enable$lambda0():void");
    }
    ...
    private final org.json.JSONObject parseRawJsonObject(org.json.JSONObject r13) {
        ...
        L_0x006a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.p007ml.ModelManager.parseRawJsonObject(org.json.JSONObject):org.json.JSONObject");
    }
                ...
                for (Map.Entry next : taskHandlers.entrySet()) {
                    ...
                    if (Intrinsics.areEqual((Object) str2, (Object) Task.MTML_APP_EVENT_PREDICTION.toUseCase())) {
                        ...
                        if (FeatureManager.isEnabled(FeatureManager.Feature.SuggestedEvents) && isLocaleEnglish()) {
                            arrayList.add(taskHandler.setOnPostExecute($$Lambda$ModelManager$1Ylw1DneFZoPXYUKxfroZtySgO0.INSTANCE));
                        }
                        str = assetUri;
                        i = max;
                    }
                    if (Intrinsics.areEqual((Object) str2, (Object) Task.MTML_INTEGRITY_DETECT.toUseCase())) {
                        ...
                        if (FeatureManager.isEnabled(FeatureManager.Feature.IntelligentIntegrity)) {
                            arrayList.add(taskHandler.setOnPostExecute($$Lambda$ModelManager$gpxK6_P9sTXSwBIkd4I7JZGyP8U.INSTANCE));
                        }
                    }
                }
    ...
    public static final void m2505enableMTML$lambda1() {
        Class<ModelManager> cls = ModelManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final void m2506enableMTML$lambda2() {
        Class<ModelManager> cls = ModelManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
        ...
        public static final class Companion {
            ...
            public final void execute(TaskHandler taskHandler, List<TaskHandler> list) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x003a: INVOKE  
                     ...
                     com.facebook.appevents.ml.ModelManager.TaskHandler.getVersionId():int type: VIRTUAL)
                      ...
                      (wrap: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28 : 0x0037: CONSTRUCTOR  (r1v4 com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28) = 
                      (r4v0 'list' java.util.List<com.facebook.appevents.ml.ModelManager$TaskHandler>)
                     call: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28.<init>(java.util.List):void type: CONSTRUCTOR)
                    ...
                    Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0037: CONSTRUCTOR  (r1v4 com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28) = 
                      (r4v0 'list' java.util.List<com.facebook.appevents.ml.ModelManager$TaskHandler>)
                     call: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28.<init>(java.util.List):void type: CONSTRUCTOR in method: com.facebook.appevents.ml.ModelManager.TaskHandler.Companion.execute(com.facebook.appevents.ml.ModelManager$TaskHandler, java.util.List):void, dex: classes.dex
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:256)
                    	...
                    	... 59 more
                    Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28, state: NOT_LOADED
                ...
                /*
                    ...
                    com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28 r1 = new com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$fdh8EYwhbp9KjiLYo57FJqa-E28
                    r1.<init>(r4)
                    r2.download(r3, r0, r1)
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.p007ml.ModelManager.TaskHandler.Companion.execute(com.facebook.appevents.ml.ModelManager$TaskHandler, java.util.List):void");
            }

            /* access modifiers changed from: private */
            /* renamed from: execute$lambda-1  reason: not valid java name */
            public static final void m2508execute$lambda1(List list, File file) {
                Intrinsics.checkNotNullParameter(list, "$slaves");
                ...
                if (build != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        /*  JADX ERROR: Method code generation error
                            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x004e: INVOKE  
                             ...
                             com.facebook.appevents.ml.ModelManager.TaskHandler.getVersionId():int type: VIRTUAL)
                              ...
                              (wrap: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E : 0x004b: CONSTRUCTOR  (r4v0 com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E) = 
                              (r0v5 'taskHandler' com.facebook.appevents.ml.ModelManager$TaskHandler)
                              (r6v1 'build' com.facebook.appevents.ml.Model)
                             call: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E.<init>(com.facebook.appevents.ml.ModelManager$TaskHandler, com.facebook.appevents.ml.Model):void type: CONSTRUCTOR)
                             com.facebook.appevents.ml.ModelManager.TaskHandler.Companion.download(java.lang.String, java.lang.String, com.facebook.appevents.internal.FileDownloadTask$Callback):void type: DIRECT in method: com.facebook.appevents.ml.ModelManager.TaskHandler.Companion.execute$lambda-1(java.util.List, java.io.File):void, dex: classes.dex
                            	...
                            	at jadx.core.ProcessClass.generateCode(ProcessClass.java:61)
                            	at jadx.core.dex.nodes.ClassNode.decompile(ClassNode.java:273)
                            Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x004b: CONSTRUCTOR  (r4v0 com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E) = 
                              (r0v5 'taskHandler' com.facebook.appevents.ml.ModelManager$TaskHandler)
                              (r6v1 'build' com.facebook.appevents.ml.Model)
                             call: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E.<init>(com.facebook.appevents.ml.ModelManager$TaskHandler, com.facebook.appevents.ml.Model):void type: CONSTRUCTOR in method: com.facebook.appevents.ml.ModelManager.TaskHandler.Companion.execute$lambda-1(java.util.List, java.io.File):void, dex: classes.dex
                            	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:256)
                            	at jadx.core.codegen.InsnGen.addWrappedArg(InsnGen.java:123)
                            	at jadx.core.codegen.InsnGen.addArg(InsnGen.java:107)
                            	at jadx.core.codegen.InsnGen.generateMethodArguments(InsnGen.java:787)
                            	...
                            	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:250)
                            	... 71 more
                            Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E, state: NOT_LOADED
                            	at jadx.core.dex.nodes.ClassNode.ensureProcessed(ClassNode.java:260)
                            	at jadx.core.codegen.InsnGen.makeConstructor(InsnGen.java:606)
                            	at jadx.core.codegen.InsnGen.makeInsnBody(InsnGen.java:364)
                            	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:231)
                        ...
                        /*
                            ...
                            com.facebook.appevents.ml.Model$Companion r0 = com.facebook.appevents.p007ml.Model.Companion
                        ...
                        L_0x0016:
                            ...
                            com.facebook.appevents.ml.ModelManager$TaskHandler r0 = (com.facebook.appevents.p007ml.ModelManager.TaskHandler) r0
                            ...
                            com.facebook.appevents.ml.ModelManager$TaskHandler$Companion r2 = com.facebook.appevents.p007ml.ModelManager.TaskHandler.Companion
                            java.lang.String r3 = r0.getRuleUri()
                            com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E r4 = new com.facebook.appevents.ml.-$$Lambda$ModelManager$TaskHandler$Companion$q8oFjboNcAGDuiWTveJQvyLgP5E
                            r4.<init>(r0, r6)
                        ...
                        L_0x0052:
                            return
                        */
                        throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.p007ml.ModelManager.TaskHandler.Companion.m2508execute$lambda1(java.util.List, java.io.File):void");
                    }

                    /* access modifiers changed from: private */
                    /* renamed from: execute$lambda-1$lambda-0  reason: not valid java name */
                    public static final void m2509execute$lambda1$lambda0(TaskHandler taskHandler, Model model, File file) {
