...
public final class ActivityLifecycleTracker {
    ...
    public static final void startTracking(Application application, String str) {
        ...
        if (tracking.compareAndSet(false, true)) {
            ...
            FeatureManager.checkFeature(FeatureManager.Feature.CodelessEvents, $$Lambda$ActivityLifecycleTracker$Z9JmDigumkq1YpuefCzm8JwFGEY.INSTANCE);
            appId = str;
    ...
    public static final void m2503startTracking$lambda0(boolean z) {
        if (z) {
    ...
    public static final void onActivityCreated(Activity activity) {
        singleThreadExecutor.execute($$Lambda$ActivityLifecycleTracker$YVndz85gTGcjRFIjcU5g6Oa9hTk.INSTANCE);
    }

    /* access modifiers changed from: private */
    /* renamed from: onActivityCreated$lambda-1  reason: not valid java name */
    public static final void m2499onActivityCreated$lambda1() {
    ...
    public static final void onActivityResumed(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable(currentTimeMillis, activityName, activity.getApplicationContext()) {
            ...
            public final void run() {
                ActivityLifecycleTracker.m2502onActivityResumed$lambda2(this.f$0, this.f$1, this.f$2);
            }
        });
    }
    ...
    public static final void m2502onActivityResumed$lambda2(long j, String str, Context context) {
        SessionInfo sessionInfo;
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable(currentTimeMillis, activityName) {
            ...
            public final void run() {
                ActivityLifecycleTracker.m2500onActivityPaused$lambda6(this.f$0, this.f$1);
            }
        });
    }
    ...
    public static final void m2500onActivityPaused$lambda6(long j, String str) {
        Intrinsics.checkNotNullParameter(str, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), (Long) null, (UUID) null, 4, (DefaultConstructorMarker) null);
        }
        ...
        if (foregroundActivityCount.get() <= 0) {
            $$Lambda$ActivityLifecycleTracker$gs8m1hOCTYKVIczzc7Lt8QkyWU r0 = new Runnable(j, str) {
                public final /* synthetic */ long f$0;
                public final /* synthetic */ String f$1;
                ...
                public final void run() {
                    ActivityLifecycleTracker.m2501onActivityPaused$lambda6$lambda4(this.f$0, this.f$1);
                }
            };
    ...
    public static final void m2501onActivityPaused$lambda6$lambda4(long j, String str) {
        Intrinsics.checkNotNullParameter(str, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), (Long) null, (UUID) null, 4, (DefaultConstructorMarker) null);
        }
