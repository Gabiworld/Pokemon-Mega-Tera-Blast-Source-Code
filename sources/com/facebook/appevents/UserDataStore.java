...
public final class UserDataStore {
            ...
            try {
                ...
                FacebookSdk.getExecutor().execute(new Runnable(str, str2) {
                    ...
                    public final void run() {
                        UserDataStore.m2473writeDataIntoCache$lambda0(this.f$0, this.f$1);
                    }
                });
            } catch (Throwable th) {
    ...
    public static final void m2473writeDataIntoCache$lambda0(String str, String str2) {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                InternalAppEventsLogger.Companion.getAnalyticsExecutor().execute(new Runnable(bundle) {
                    ...
                    public final void run() {
                        UserDataStore.m2472setUserDataAndHash$lambda1(this.f$0);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
    ...
    public static final void m2472setUserDataAndHash$lambda1(Bundle bundle) {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                if (!initialized.get()) {
    ...
    public static final void clear() {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                InternalAppEventsLogger.Companion.getAnalyticsExecutor().execute($$Lambda$UserDataStore$g2rGkYzTzBUJsfYE4FUyiSZOoe8.INSTANCE);
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
            }
        }
    ...
    public static final void m2470clear$lambda2() {
        Class<UserDataStore> cls = UserDataStore.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                if (!initialized.get()) {
