...
public final class IntegrityManager {
    ...
    private final boolean shouldFilter(String str) {
        ...
        try {
            return !Intrinsics.areEqual((Object) INTEGRITY_TYPE_NONE, (Object) getIntegrityPredictionResult(str));
        } catch (Throwable th) {
