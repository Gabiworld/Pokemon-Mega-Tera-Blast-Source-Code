...
public final class InAppPurchaseBillingClientWrapper {
            ...
            try {
                ...
                queryPurchaseHistoryAsync(str, new Runnable(runnable) {
                    ...
                    public final void run() {
                        InAppPurchaseBillingClientWrapper.m2495queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper.this, this.f$1);
                    }
                });
            } catch (Throwable th) {
    ...
    public static final void m2495queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, Runnable runnable) {
        Class<InAppPurchaseBillingClientWrapper> cls = InAppPurchaseBillingClientWrapper.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
