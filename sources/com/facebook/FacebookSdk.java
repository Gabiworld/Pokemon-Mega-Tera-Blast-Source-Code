...
public final class FacebookSdk {
    ...
    private static GraphRequestCreator graphRequestCreator = $$Lambda$FacebookSdk$rRvSJEo01B75lCVao9yemAlNbP0.INSTANCE;
    ...
    @Metadata(mo13301d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bá\u0001\u0018\u00002\u00020\u0001J0\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u00072\b\u0010\b\u001a\u0004\u0018\u00010\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bH&¨\u0006\f"}, mo13302d2 = {"Lcom/facebook/FacebookSdk$GraphRequestCreator;", "", "createPostRequest", "Lcom/facebook/GraphRequest;", "accessToken", "Lcom/facebook/AccessToken;", "publishUrl", "", "publishParams", "Lorg/json/JSONObject;", "callback", "Lcom/facebook/GraphRequest$Callback;", "facebook-core_release"}, mo13303k = 1, mo13304mv = {1, 5, 1}, mo13306xi = 48)
    /* compiled from: FacebookSdk.kt */
    ...
    @Metadata(mo13301d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bæ\u0001\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, mo13302d2 = {"Lcom/facebook/FacebookSdk$InitializeCallback;", "", "onInitialized", "", "facebook-core_release"}, mo13303k = 1, mo13304mv = {1, 5, 1}, mo13306xi = 48)
    /* compiled from: FacebookSdk.kt */
    ...
    public static final GraphRequest m2427graphRequestCreator$lambda0(AccessToken accessToken, String str, JSONObject jSONObject, GraphRequest.Callback callback) {
    ...
    public static final synchronized void sdkInitialize(android.content.Context r4, com.facebook.FacebookSdk.InitializeCallback r5) {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r1)     // Catch:{ all -> 0x00ee }
            java.util.concurrent.atomic.AtomicBoolean r1 = sdkInitialized     // Catch:{ all -> 0x00ee }
            boolean r2 = r1.get()     // Catch:{ all -> 0x00ee }
            if (r2 == 0) goto L_0x0018
            if (r5 != 0) goto L_0x0013
            goto L_0x0016
        L_0x0013:
            r5.onInitialized()     // Catch:{ all -> 0x00ee }
        L_0x0016:
            monitor-exit(r0)
            return
        L_0x0018:
            com.facebook.internal.Validate r2 = com.facebook.internal.Validate.INSTANCE     // Catch:{ all -> 0x00ee }
            r2 = 0
            com.facebook.internal.Validate.hasFacebookActivity(r4, r2)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.Validate r3 = com.facebook.internal.Validate.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.Validate.hasInternetPermissions(r4, r2)     // Catch:{ all -> 0x00ee }
            android.content.Context r2 = r4.getApplicationContext()     // Catch:{ all -> 0x00ee }
            java.lang.String r3 = "applicationContext.applicationContext"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x00ee }
            applicationContext = r2     // Catch:{ all -> 0x00ee }
            com.facebook.appevents.AppEventsLogger$Companion r2 = com.facebook.appevents.AppEventsLogger.Companion     // Catch:{ all -> 0x00ee }
            r2.getAnonymousAppDeviceGUID(r4)     // Catch:{ all -> 0x00ee }
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x00ee }
            r2 = 0
            if (r4 == 0) goto L_0x00e8
            loadDefaultsFromMetadata$facebook_core_release(r4)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.Utility r4 = com.facebook.internal.Utility.INSTANCE     // Catch:{ all -> 0x00ee }
            java.lang.String r4 = applicationId     // Catch:{ all -> 0x00ee }
            boolean r4 = com.facebook.internal.Utility.isNullOrEmpty((java.lang.String) r4)     // Catch:{ all -> 0x00ee }
            if (r4 != 0) goto L_0x00e0
            r4 = 1
            r1.set(r4)     // Catch:{ all -> 0x00ee }
            boolean r4 = getAutoInitEnabled()     // Catch:{ all -> 0x00ee }
            if (r4 == 0) goto L_0x0052
            fullyInitialize()     // Catch:{ all -> 0x00ee }
        L_0x0052:
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x00ee }
            if (r4 == 0) goto L_0x00da
            boolean r4 = r4 instanceof android.app.Application     // Catch:{ all -> 0x00ee }
            if (r4 == 0) goto L_0x0076
            com.facebook.UserSettingsManager r4 = com.facebook.UserSettingsManager.INSTANCE     // Catch:{ all -> 0x00ee }
            boolean r4 = com.facebook.UserSettingsManager.getAutoLogAppEventsEnabled()     // Catch:{ all -> 0x00ee }
            if (r4 == 0) goto L_0x0076
            com.facebook.appevents.internal.ActivityLifecycleTracker r4 = com.facebook.appevents.internal.ActivityLifecycleTracker.INSTANCE     // Catch:{ all -> 0x00ee }
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x00ee }
            if (r4 == 0) goto L_0x0070
            android.app.Application r4 = (android.app.Application) r4     // Catch:{ all -> 0x00ee }
            java.lang.String r1 = applicationId     // Catch:{ all -> 0x00ee }
            com.facebook.appevents.internal.ActivityLifecycleTracker.startTracking(r4, r1)     // Catch:{ all -> 0x00ee }
            goto L_0x0076
        L_0x0070:
            java.lang.String r4 = "applicationContext"
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r4)     // Catch:{ all -> 0x00ee }
            throw r2     // Catch:{ all -> 0x00ee }
        L_0x0076:
            com.facebook.internal.FetchedAppSettingsManager r4 = com.facebook.internal.FetchedAppSettingsManager.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FetchedAppSettingsManager.loadAppSettingsAsync()     // Catch:{ all -> 0x00ee }
            com.facebook.internal.NativeProtocol r4 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.NativeProtocol.updateAllAvailableProtocolVersionsAsync()     // Catch:{ all -> 0x00ee }
            com.facebook.internal.BoltsMeasurementEventListener$Companion r4 = com.facebook.internal.BoltsMeasurementEventListener.Companion     // Catch:{ all -> 0x00ee }
            android.content.Context r1 = applicationContext     // Catch:{ all -> 0x00ee }
            if (r1 == 0) goto L_0x00d4
            r4.getInstance(r1)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.LockOnGetVariable r4 = new com.facebook.internal.LockOnGetVariable     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$l5BfhEW0E2Knw4iBH_1AfUbqf68 r1 = com.facebook.$$Lambda$FacebookSdk$l5BfhEW0E2Knw4iBH_1AfUbqf68.INSTANCE     // Catch:{ all -> 0x00ee }
            r4.<init>(r1)     // Catch:{ all -> 0x00ee }
            cacheDir = r4     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.Instrument     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$2_0K3R5F7TSTdEG84TCLRkQv7a0 r1 = com.facebook.$$Lambda$FacebookSdk$2_0K3R5F7TSTdEG84TCLRkQv7a0.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.AppEvents     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$T2Q-QrD-XnBEqekKY4vZSQIk1AM r1 = com.facebook.$$Lambda$FacebookSdk$T2QQrDXnBEqekKY4vZSQIk1AM.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.ChromeCustomTabsPrefetching     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$gGkoiBGrEXs-Nd9QKuvSQOPFi6s r1 = com.facebook.$$Lambda$FacebookSdk$gGkoiBGrEXsNd9QKuvSQOPFi6s.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.IgnoreAppSwitchToLoggedOut     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$ElSKf-6nj6MFR7BXk3FBsf25M-o r1 = com.facebook.$$Lambda$FacebookSdk$ElSKf6nj6MFR7BXk3FBsf25Mo.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.BypassAppSwitch     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$I5IDcPOCgFpsJ3FbM5f1_RyPPjM r1 = com.facebook.$$Lambda$FacebookSdk$I5IDcPOCgFpsJ3FbM5f1_RyPPjM.INSTANCE     // Catch:{ all -> 0x00ee }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x00ee }
            java.util.concurrent.FutureTask r4 = new java.util.concurrent.FutureTask     // Catch:{ all -> 0x00ee }
            com.facebook.-$$Lambda$FacebookSdk$QXkRtamIwU9QKfxXqTl0cZN1r3g r1 = new com.facebook.-$$Lambda$FacebookSdk$QXkRtamIwU9QKfxXqTl0cZN1r3g     // Catch:{ all -> 0x00ee }
            r1.<init>()     // Catch:{ all -> 0x00ee }
            r4.<init>(r1)     // Catch:{ all -> 0x00ee }
            java.util.concurrent.Executor r5 = getExecutor()     // Catch:{ all -> 0x00ee }
            java.lang.Runnable r4 = (java.lang.Runnable) r4     // Catch:{ all -> 0x00ee }
            r5.execute(r4)     // Catch:{ all -> 0x00ee }
            monitor-exit(r0)
            return
        L_0x00d4:
            java.lang.String r4 = "applicationContext"
        ...
        L_0x00da:
            ...
            throw r2     // Catch:{ all -> 0x00ee }
        L_0x00e0:
            com.facebook.FacebookException r4 = new com.facebook.FacebookException     // Catch:{ all -> 0x00ee }
            ...
            r4.<init>((java.lang.String) r5)     // Catch:{ all -> 0x00ee }
    ...
    public static final File m2432sdkInitialize$lambda3() {
    ...
    public static final void m2433sdkInitialize$lambda4(boolean z) {
        if (z) {
    ...
    public static final void m2434sdkInitialize$lambda5(boolean z) {
        if (z) {
    ...
    public static final void m2435sdkInitialize$lambda6(boolean z) {
        if (z) {
    ...
    public static final void m2436sdkInitialize$lambda7(boolean z) {
        if (z) {
    ...
    public static final void m2437sdkInitialize$lambda8(boolean z) {
        if (z) {
    ...
    public static final Void m2438sdkInitialize$lambda9(InitializeCallback initializeCallback) {
            ...
            try {
                ...
                getExecutor().execute(new Runnable(context.getApplicationContext(), str) {
                    ...
                    public final void run() {
                        FacebookSdk.m2431publishInstallAsync$lambda15(this.f$0, this.f$1);
                    }
                });
    ...
    public static final void m2431publishInstallAsync$lambda15(Context context, String str) {
        Intrinsics.checkNotNullParameter(str, "$applicationId");
