...
public final class Decoder {
    private static final String[] DIGIT_TABLE = {"CTRL_PS", " ", AppEventsConstants.EVENT_PARAM_VALUE_NO, "1", "2", "3", "4", "5", QGConstant.LOGIN_OPEN_TYPE_FACEBOOK, "7", QGConstant.LOGIN_OPEN_TYPE_GOOGLE, QGConstant.LOGIN_OPEN_TYPE_NAVER, ",", ".", "CTRL_UL", "CTRL_US"};
    ...
    static /* synthetic */ class C08861 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.aztec.decoder.Decoder.C08861.<clinit>():void");
        }
    }

    private static String getCharacter(Table table, int i) {
        int i2 = C08861.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
