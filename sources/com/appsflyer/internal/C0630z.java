...
public final class C0630z {
    ...
    static java.util.Map<java.lang.String, java.lang.String> AFInAppEventType(android.content.Context r12, java.util.Map<java.lang.String, java.lang.String> r13, android.net.Uri r14) {
        ...
        L_0x00e2:
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C0630z.AFInAppEventType(android.content.Context, java.util.Map, android.net.Uri):java.util.Map");
    }
    ...
    public C0630z(String str, byte[] bArr, String str2, Map<String, String> map, boolean z) {
    ...
    public C0630z(String str, String str2) {
