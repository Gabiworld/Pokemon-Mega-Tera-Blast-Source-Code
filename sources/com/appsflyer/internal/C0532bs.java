...
public final class C0532bs extends C0527bn<C0534bu> {
    private final C0536bw AFInAppEventParameterName;
    private final C0453aa AFInAppEventType;
    public C0534bu AFKeystoreWrapper = null;
    private final C0516bd AFLogger$LogLevel;
    private final String AFVersionDeclaration;
    private final C0545cb getLevel;
    public C0493ap valueOf;
    private final C0537bx values;

    public C0532bs(C0536bw bwVar, C0453aa aaVar, C0543ca caVar, C0537bx bxVar, C0516bd bdVar, C0545cb cbVar, String str) {
        super(C0533bt.RC_CDN, new C0533bt[0], "UpdateRemoteConfiguration");
    ...
    public final C0528bo values() throws Exception {
        try {
            C0534bu AFKeystoreWrapper2 = AFKeystoreWrapper();
            this.AFKeystoreWrapper = AFKeystoreWrapper2;
            if (AFKeystoreWrapper2 == C0534bu.FAILURE) {
                return C0528bo.FAILURE;
            }
            return C0528bo.SUCCESS;
        } catch (InterruptedIOException | InterruptedException unused) {
            this.AFKeystoreWrapper = C0534bu.FAILURE;
            return C0528bo.TIMEOUT;
        }
    }
    ...
    private com.appsflyer.internal.C0534bu AFKeystoreWrapper() throws java.lang.InterruptedException, java.io.InterruptedIOException {
        /*
            r16 = this;
            r9 = r16
        ...
        L_0x002c:
            ...
            r7[r3] = r1
            java.lang.String r1 = com.appsflyer.internal.C0474ag.AFInAppEventParameterName((java.lang.String[]) r7)
            java.lang.String r1 = com.appsflyer.internal.C0474ag.valueOf(r1, r2)
            r13 = r1
            goto L_0x004d
        L_0x0049:
        ...
        L_0x004d:
            ...
            com.appsflyer.internal.bu r0 = com.appsflyer.internal.C0534bu.FAILURE
            return r0
        L_0x0057:
            ...
            com.appsflyer.AFLogger.values((java.lang.String) r1)     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            com.appsflyer.internal.cb r1 = r9.getLevel     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            ...
            java.lang.String r1 = com.appsflyer.internal.C0516bd.AFKeystoreWrapper     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            goto L_0x0073
        L_0x0071:
            java.lang.String r1 = com.appsflyer.internal.C0516bd.values     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
        L_0x0073:
            ...
            com.appsflyer.internal.ao r1 = (com.appsflyer.internal.C0492ao) r1     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
        ...
        L_0x011c:
            ...
            java.nio.charset.Charset r12 = com.appsflyer.internal.C0537bx.AFInAppEventParameterName     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            ...
            r6 = r0
            com.appsflyer.internal.ao r6 = (com.appsflyer.internal.C0492ao) r6     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            r8 = 0
            r1 = r16
            r2 = r13
            r3 = r10
            ...
            com.appsflyer.internal.bu r0 = com.appsflyer.internal.C0534bu.SUCCESS     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            return r0
        L_0x0196:
            com.appsflyer.internal.cw r7 = r2.AFInAppEventType     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            Body r0 = r14.valueOf     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            ...
            com.appsflyer.internal.bu r0 = com.appsflyer.internal.C0534bu.FAILURE     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            return r0
        L_0x01ae:
        ...
        L_0x01d9:
            ...
            com.appsflyer.AFLogger.AFInAppEventParameterName(r0)     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            com.appsflyer.internal.bu r0 = com.appsflyer.internal.C0534bu.USE_CACHED     // Catch:{ IOException -> 0x0214, all -> 0x01e1 }
            return r0
        L_0x01e1:
            r0 = move-exception
        ...
        L_0x0255:
            goto L_0x0254
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C0532bs.AFKeystoreWrapper():com.appsflyer.internal.bu");
    }

    private void AFInAppEventType(String str, long j, C0531br<?> brVar, C0492ao aoVar, C0567cw cwVar, Throwable th) {
        int i;
        long j2;
        Throwable th2;
        long j3;
        String str2;
        C0531br<?> brVar2 = brVar;
        C0492ao aoVar2 = aoVar;
        Throwable th3 = th;
        if (brVar2 != null) {
        ...
        this.valueOf = new C0493ap(str2, str, j3, System.currentTimeMillis() - j, i, cwVar, th2);
    }
}
