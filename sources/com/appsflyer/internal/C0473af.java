...
public final class C0473af {
    ...
    public static synchronized String valueOf(WeakReference<Context> weakReference) {
        synchronized (C0473af.class) {
            ...
            if (values == null) {
                String str2 = null;
                if (weakReference.get() != null) {
                    str2 = C0458ac.AFInAppEventType(weakReference.get()).getString("AF_INSTALLATION", (String) null);
                }
                if (str2 != null) {
                    values = str2;
                } else {
                    try {
                        ...
                        String str3 = values;
                        SharedPreferences.Editor edit = C0458ac.AFInAppEventType(weakReference.get()).edit();
    ...
    private static java.lang.String values(java.io.File r6) {
        ...
        L_0x0052:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.C0473af.values(java.io.File):java.lang.String");
    }
}
