...
public final class DurationKt {
    ...
    private static final long m3991timesmvk6XK0(int i, long j) {
        return Duration.m3949timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m3990timeskIfJnKk(double d, long j) {
        return Duration.m3948timesUwyO8pc(j, d);
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m3910constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m3910constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m3910constructorimpl((j << 1) + ((long) i));
    }
