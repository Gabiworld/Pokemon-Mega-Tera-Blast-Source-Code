...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m2419ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m2420ln(float f) {
